...
async function testBackend() {
  ...
  try {
    ...
    const testBarcode = "731509839685"; // Example barcode (Where the Crawdads Sing book)
    console.log(
    ...
    //the below thing is same as we did in the index.js but there instead of puting the whhole post and header we simply put them under the options
    const apiResponse = await fetch(`${serverUrl}/api/search`, {//this is the api endpoint we are going to test
